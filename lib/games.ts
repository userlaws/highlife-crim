export const gameCatalog = {
  ...
  volt: {
    ...
    instructions: 'Use Up / Down (W / S) to choose an input and Left / Right (A / D) to choose an output. The result previews your connection. Outputs hide multipliers ×1, ×10, and ×50; their symbols change each round. Press Enter to commit. Connect all three inputs to reach the target. Connections cannot be undone. Touch users can select both sides and tap Connect.',
